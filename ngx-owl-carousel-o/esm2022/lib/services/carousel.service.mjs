...
export class CarouselService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.0.2", ngImport: i0, type: CarouselService, deps: [{ token: i1.OwlLogger }], target: i0.ɵɵFactoryTarget.Injectable });
