...
describe('Logger Service', () => {
  ...
  describe('log', () => {
    it('should delegate to console.log', inject(
      [OwlLogger],
      (logger: OwlLogger) => {
  ...
  describe('warn', () => {
    it('should delegate to console.warn', inject(
      [OwlLogger],
      (logger: OwlLogger) => {
  ...
  describe('error', () => {
    it('should delegate to ErrorHandler', inject(
      [OwlLogger, ErrorHandler],
      (logger: OwlLogger, errorHandler: ErrorHandler) => {
